...
def detect_pitch(chunk, min_frequency=82.0, max_frequency=1000.0, samplerate=44100.0, sens=0.1, ratio=12.0):
    '''
    ...
    '''
    # print("went to 'detect_pitch' function")
    # print()
    # print('"chunk":', chunk)
    ...
    chunk2 = chunk.data[:]
    # print("'chunk2':", chunk2)
    # print("'chunk2' type:", type(chunk2))
    # print('FAIL HERE!', chunk.data())
...
def musical_detect_pitch(chunk, min_note=40.0, max_note=84.0, samplerate=44100, sens=0.1, ratio=12.0, smooth=1.0):
    '''Return the pitch present in a chunk of sampled sound
    ...
    # print("_previous_pitch", _previous_pitch)
